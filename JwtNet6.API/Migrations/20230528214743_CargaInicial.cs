...
namespace JwtNet6.API.Migrations
{
    public partial class CargaInicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "TBT_TIPOS_DOCUM",
                schema: "WEB",
                columns: table => new
                {
                    IDD_TIPOS_DOCUM = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DES_TIPOS_DOCUM = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBT_TIPOS_DOCUM", x => x.IDD_TIPOS_DOCUM);
                });
